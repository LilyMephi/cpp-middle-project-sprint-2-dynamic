...
int main(int argc, char **argv) {
    ...
    //     auto res =
    //         stdx::format_string<>::get_number_placeholders("i have {%f} apple and my dad has {%s} apple sum is
    //         {%d}");
    ...
    //     }
    // auto result = stdx::scan<float, int>("{%f} {%d}"_fs, "3.14 123");
    // if (result) {
    ...
    // }
    //     return 0;
    // auto result = stdx::scan<int, float>("{%d} {%f}"_fs, "42 3.14");
